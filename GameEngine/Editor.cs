...
namespace GameEngine
{
    ...
    public partial class Editor : Form
    {
        ...
        {
            grid = content.Load <Texture2D>("128grid");
        ...
        public void Update(List<GameObject> objects, Map map)
        {
            ...
            if ((ks.IsKeyDown(Microsoft.Xna.Framework.Input.Keys.LeftControl) || (ks.IsKeyDown(Microsoft.Xna.Framework.Input.Keys.RightControl))) &&
                    mode != CreateMode.Walls)
            {
                //We held down control and clicked on something, auto select what we clicked in the list box:
                if (ms.LeftButton == Microsoft.Xna.Framework.Input.ButtonState.Pressed && mode == CreateMode.Objects)
                {
                ...
                else if (ms.LeftButton == Microsoft.Xna.Framework.Input.ButtonState.Pressed && mode == CreateMode.Decor)
                {
                ...
                else if (ks.IsKeyDown(Microsoft.Xna.Framework.Input.Keys.C) && mode == CreateMode.Decor)
                    CopyDecor(); //Make a copy of the highlighted decor.
            }
            else if (ms.LeftButton == Microsoft.Xna.Framework.Input.ButtonState.Pressed && GameWindowFocused() == true)
            {
            ...
            else if (ms.RightButton == Microsoft.Xna.Framework.Input.ButtonState.Pressed && GameWindowFocused() == true)
            {
                if (mode == CreateMode.Walls)
                {
                    #region Remove Walls
            ...
            else //we're paused, move the camera with arrow keys...
            {
                if (ks.IsKeyDown(Microsoft.Xna.Framework.Input.Keys.Right))
                    cameraPosition.X += 6;
                else if (ks.IsKeyDown(Microsoft.Xna.Framework.Input.Keys.Left))
                    cameraPosition.X -= 6;
